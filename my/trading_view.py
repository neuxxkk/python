...
def graphic(period, coin):
  ...
  plt.ylabel(f'1{coin} price', color = '#D1D4DC', labelpad=15, fontsize = 11)
...
#                            0 = início;  x = final(até);  -1 = steps(regressivo) 
  ...
  t = plt.text(day-(day*0.0005), btc+(btc*0.0005), txt, color = 'white', font = 'calibri', size = 11, fontstyle = 'normal', fontweight = 'bold')
